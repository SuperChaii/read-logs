...
/**
 * Created by chaiyibo on 2018-01-13.
 */
public class ExportUtil {
    ...
    public static void exportExcelByWorkBook (Workbook workbook, String fileName, HttpServletResponse response) throws Exception {
        exportByworkBook(workbook, fileName, response);
    }
    ...
    private static void exportByworkBook (Workbook workbook, String fileName, HttpServletResponse response) throws Exception {
        downLoadExcel(fileName, response, workbook);
    }
